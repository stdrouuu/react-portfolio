...
export const About = () => {
  const fronetendSkills = ["React", "Javascript", "HTML", "CSS", "Tailwind", "Framer"];
    ...
    <div className="bg-gradient-to-b from-[#0B0B0D] via-[#0B0B0D] to-black">
      <section id="about" className="text-white  p-8">
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="p-6 rounded-xl border-white/20 border hover:-translate-y-1 transition-all mt-5">
            ...
            <p className="text-white/50 mb-4">
              ...
              expanding my skill set to stay at the front of web
              development.
            </p>
